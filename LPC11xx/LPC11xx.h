...
typedef struct
{
    ...
    __IO uint32_t PIO0_1;       /*!< Offset: 0x010 I/O configuration for pin PIO0_1/CLKOUT/CT32B0_MAT2  */
                                /*  (R/W)                                                               */
    __IO uint32_t PIO1_8;       /*!< Offset: 0x014 I/O configuration for pin PIO1_8/CT16B1_CAP0 (R/W)   */
         uint32_t RESERVED1[1];
    __IO uint32_t PIO0_2;       /*!< Offset: 0x01C I/O configuration for pin PIO0_2/SSEL0/CT16B0_CAP0   */
                                /*  (R/W)                                                               */
    ...
    __IO uint32_t PIO0_8;       /*!< Offset: 0x060 I/O configuration for pin PIO0_8/MISO0/CT16B0_MAT0   */
                                /*  (R/W)                                                               */
    __IO uint32_t PIO0_9;       /*!< Offset: 0x064 I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1   */
                                /*  (R/W)                                                               */
    __IO uint32_t SWCLK_PIO0_10;/*!< Offset: 0x068 I/O configuration for pin SWCLK/PIO0_10/SCK0/        */
                                /*   CT16B0_MAT2 (R/W)                                                  */
    __IO uint32_t PIO1_10;      /*!< Offset: 0x06C I/O configuration for pin PIO1_10/AD6/CT16B1_MAT1    */
                                /*  (R/W)                                                               */
    __IO uint32_t PIO2_11;      /*!< Offset: 0x070 I/O configuration for pin PIO2_11/SCK0 (R/W)         */
    __IO uint32_t R_PIO0_11;    /*!< Offset: 0x074 I/O configuration for pin TDI/PIO0_11/AD0/CT32B0_MAT3*/
                                /*  (R/W)                                                               */
    __IO uint32_t R_PIO1_0;     /*!< Offset: 0x078 I/O configuration for pin TMS/PIO1_0/AD1/CT32B1_CAP0 */
                                /*  (R/W)                                                               */
    __IO uint32_t R_PIO1_1;     /*!< Offset: 0x07C I/O configuration for pin TDO/PIO1_1/AD2/CT32B1_MAT0 */
                                /*  (R/W)                                                               */
    
    __IO uint32_t R_PIO1_2;     /*!< Offset: 0x080 I/O configuration for pin nTRST/PIO1_2/AD3/          */
                                /*   CT32B1_MAT1 (R/W)                                                  */
    ...
    __IO uint32_t SWDIO_PIO1_3; /*!< Offset: 0x090 I/O configuration for pin SWDIO/PIO1_3/AD4/          */
                                /*   CT32B1_MAT2 (R/W)                                                  */
    ...
    __IO uint32_t PIO1_5;       /*!< Offset: 0x0A0 I/O configuration for pin PIO1_5/nRTS/CT32B0_CAP0    */
                                /*  (R/W)                                                               */
...
typedef struct
{
    ...
    __IO uint32_t  RS485DLY;              /*!< Offset: 0x054 RS-485/EIA-485 direction control delay     */
                                          /*   Register (R/W)                                           */
